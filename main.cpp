...
// ==================== DoubleType Funcs Implementation  ====================
...
double DoubleType::divide(double numerator, double denominator) {
  if (denominator == 0) {
    std::cout << "\nwarning, floating point division by zero returns 'inf' !\n";
  }
  return numerator / denominator;
